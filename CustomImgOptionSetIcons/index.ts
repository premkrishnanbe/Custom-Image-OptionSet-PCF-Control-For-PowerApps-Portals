...
import  IconOptionsetControl, {IProps, IIconSetup } from "./OptionSetIconsControl";
export class CustomImgOptionSetIcons implements ComponentFramework.StandardControl<IInputs, IOutputs> {
